/*
 * pt_common.h - Shared constants, structs, error codes for the pose tracking pipeline.
 *
 * Platform-independent header shared by both CUDA (Windows) and MPS (macOS) pipelines.
 * Defines data contracts between:
 ...
 *   - Platform-specific modules (arena, decode, inference, kernels)
 *
 * GPU-specific structs (PT_GpuArena) are guarded by #ifdef PT_CUDA_PIPELINE.
 *
...
/* ============================================================================
 * Sync table - maps sync_index to per-camera frame indices (CUDA pipeline only)
 * ============================================================================ */
...
/* ============================================================================
 * Pipeline configuration (CUDA pipeline only — MPS defines its own)
 * ============================================================================ */
...
/* ============================================================================
 * Timing statistics (CUDA pipeline)
 * ============================================================================ */
