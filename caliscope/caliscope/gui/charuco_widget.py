...
class CharucoConfigGroup(QWidget):
    def __init__(self, controller: Controller):
        ...
        setup_spinbox_sizing(self.column_spin, min_value=2,max_value=100, padding=10)
        ...
        setup_spinbox_sizing(self.row_spin, min_value=2,max_value=100, padding=10)
        ...
        setup_spinbox_sizing(self.width_spin,min_value=2, max_value=10000,padding=10)
        ...
        setup_spinbox_sizing(self.length_spin,min_value=2, max_value=10000,padding=10)
